...
public final class RotationUtils {
    ...
    public enum RotationsPoint {
        ...
        HEAD("Head", (start, hitBox) -> {
            return getCenterPointOnBB(hitBox, 0.9);
        }),
        CHEST("Chest", (start, hitBox) -> {
            return getCenterPointOnBB(hitBox, 0.7);
        }),
        PELVIS("Pelvis", (start, hitBox) -> {
            return getCenterPointOnBB(hitBox, 0.5);
        }),
        LEGS("Legs", (start, hitBox) -> {
            return getCenterPointOnBB(hitBox, 0.3);
        }),
        FEET("Feet", (start, hitBox) -> {
            return getCenterPointOnBB(hitBox, 0.1);
        });
