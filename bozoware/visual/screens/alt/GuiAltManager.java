...
extends GuiScreen {
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        GLDraw.glFilledQuad(50.0f, 33.0f, width - 100, height - 50, 0x90000000);
        GL11.glPushMatrix();
        ...
        for (Alt alt2 : AltManager.registry) {
            ...
            if (alt2 == this.selectedAlt) {
                if (this.isMouseOverAlt(par1, par2, y2) && Mouse.isButtonDown(0)) {
                    GLDraw.glFilledQuad(52.0f, y2 - 4, width - 103, 25, 0x70000000);
                } else if (this.isMouseOverAlt(par1, par2, y2)) {
                    GLDraw.glFilledQuad(52.0f, y2 - 4, width - 103, 25, 0x70000000);
                } else {
                    GLDraw.glFilledQuad(52.0f, y2 - 4, width - 103, 25, 0x50000000);
                }
            } else if (this.isMouseOverAlt(par1, par2, y2) && Mouse.isButtonDown(0)) {
                GLDraw.glFilledQuad(52.0f, y2, width - 103, y2, 0x70000000);
            } else if (this.isMouseOverAlt(par1, par2, y2)) {
            }
