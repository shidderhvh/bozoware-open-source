...
extends GuiScreen {
    ...
    protected void actionPerformed(GuiButton button) {
        switch (button.id) {
            ...
            case 2: {
                this.thread = new AltLoginThread(DrilledAPI.getAlt().getUsername(), DrilledAPI.getAlt().getPassword());
                this.thread.start();
            }
        }
    }
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(2, width / 2 - 100, var3 + 72 + 12 + 24, "Login with Drilled Gen"));
