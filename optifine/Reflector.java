...
public class Reflector
{
    ...
    public static ReflectorClass BozoMainMenu = new ReflectorClass(bozoware.impl.UI.BozoMainMenu.class);
    public static ReflectorField BozoMainMenu_splashText = new ReflectorField(BozoMainMenu, String.class);
