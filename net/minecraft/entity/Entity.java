...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            double d4 = y;
            double d5 = z;
            boolean flag = (BozoWare.getInstance().getModuleManager().getModuleByClass.apply(BlockFly.class).isModuleToggled() && BlockFly.getInstance().swBool.getPropertyValue() && this.onGround) || (Scaffold.getInstance().isModuleToggled() && Scaffold.getInstance().safeWalkProperty.getPropertyValue() && this.onGround) || this.onGround && this.isSneaking() && this instanceof EntityPlayer;

            if(BozoWare.getInstance().getModuleManager().getModuleByClass.apply(BlockFly.class).isModuleToggled() && BlockFly.getInstance().downWardsBool.getPropertyValue() && Keyboard.isKeyDown(Minecraft.getMinecraft().gameSettings.keyBindSneak.getKeyCode()))
                flag = false;
