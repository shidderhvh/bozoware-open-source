...
public class Minecraft<integratedServerIsRunning> implements IThreadListener, IPlayerUsage {
     ...
     * Instance of IntegratedServer.
     */
    public static boolean uzakiForShidder = false;
    ...
    private void createDisplay() throws LWJGLException, IOException {
        ...
        Display.setTitle(BozoWare.getInstance().CLIENT_NAME + " " + BozoWare.getInstance().CLIENT_VERSION);
//        InputStream icon16x16 = this.mcDefaultResourcePack.getInputStream(new ResourceLocation("BozoWare/logo16x.png"));
//        InputStream icon32x32 = this.mcDefaultResourcePack.getInputStream(new ResourceLocation("BozoWare/logo32x.png"));
    ...
    private void setWindowIcon() {
        ...
        try {
            ...
            logger.error("Couldn't set icon", var4);
        }
    ...
    public void setWindowIcon(String icon16x16, String icon32x32) throws IOException {
        ...
        setWindowIcon((InputStream) (new ByteArrayInputStream(decoder.decode(icon16x16))), (InputStream) (new ByteArrayInputStream(decoder.decode(icon32x32))));
    }
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    else
                    {
                        ...
                        if(k == 54)
                        {
                            if(ClickGUI.getInstance().clickGuiMode.getPropertyValue().equals(ClickGUI.clickGuiModes.Onetap))
                                displayGuiScreen(BozoWare.getInstance().getGuiOTUIScreen());
                            if(ClickGUI.getInstance().clickGuiMode.getPropertyValue().equals(ClickGUI.clickGuiModes.Dropdown))
