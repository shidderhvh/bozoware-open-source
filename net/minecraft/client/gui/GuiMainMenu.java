...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
    ...
    public void initGui() {
        ...
        //        this.buttonList.add(new GuiButton(69, this.width / 2 + 2, j + 72 + 6, 98, 20, "Protocol"));
        //        this.buttonList.add(new VersionSlider(100, 100, 100, 90, 20));
    ...
    private void drawPanorama(int p_73970_1_, int p_73970_2_, float p_73970_3_) {
        ...
        for (int j = 0; j < i * i; ++j) {
            ...
            for (int k = 0; k < 6; ++k) {
                ...
                // un comment for world background
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        int k = 30;
        this.drawGradientRect(0, 0, this.width, this.height, 16777215, Integer.MIN_VALUE);
        this.drawGradientRect(0, 0, this.width, this.height, Integer.MIN_VALUE, 16777215);
        ...
        String s1 = "By Kobley, Posk, and Shidder"; //old: Copyright Mojang AB. Do not distribute!
