...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private void hurtCameraEffect(float partialTicks) {
        if (this.mc.getRenderViewEntity() instanceof EntityLivingBase) {
            ...
            HurtShakeEvent HurtCamShakeEvent = new HurtShakeEvent();
            BozoWare.getInstance().getEventManager().callEvent(HurtCamShakeEvent);

            if(HurtCamShakeEvent.isCancelled()) {return;}
...
//                    this.mc.ingameGUI.getChatGUI().printChatMessage(chatcomponenttext);
    ...
    private void updateMainMenu(BozoMainMenu p_updateMainMenu_1_)
    {
        try
        {
            String s = null;
            ...
            Field[] afield = BozoMainMenu.class.getDeclaredFields();
