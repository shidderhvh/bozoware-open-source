...
import bozoware.impl.event.visual.EventRenderItem;
...
public class ItemRenderer
{
    ...
    private void func_178098_a(float p_178098_1_, AbstractClientPlayer clientPlayer)
    {
        ...
        GlStateManager.translate(f1 * 0.0F, f1 * 0.0F, f1 * 0.2F);
                ...
                switch (ItemRenderer.ItemRenderer$1.field_178094_a[enumaction.ordinal()])
                {
                    ...
                    case 4:
                        if (Animations.getInstance().isModuleToggled()){
                            float sizeFactor = Animations.getInstance().Size.getPropertyValue();
                            float X = Animations.getInstance().Xpos.getPropertyValue();
                            float Y = Animations.getInstance().Ypos.getPropertyValue();
                            float Z = Animations.getInstance().Zpos.getPropertyValue();
                            switch (Animations.getInstance().blockMode.getPropertyValue()) {
                                case Swing:
                                    GL11.glScalef(sizeFactor, sizeFactor, 1);
                                ...
                                case Swong:
                                    ...
                                    GL11.glRotated(-scalableProg * 35.0F, scalableProg / 2.9, 0, 5.0F);
                                    GL11.glRotated(-scalableProg * 55.0F, 4.0F, scalableProg / 0.7, 0F);
                                    this.func_178103_d();
                                    break;
                                case Slide:
                                    GL11.glScalef(sizeFactor, sizeFactor, 1);
