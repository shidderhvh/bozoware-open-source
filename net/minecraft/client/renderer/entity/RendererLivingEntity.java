    ...
    protected void renderModel(T entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_)
    {
        ...
        if (flag || flag1)
        {
            ...
            if(BozoWare.getInstance().getModuleManager().getModuleByClass.apply(Chams.class).isModuleToggled() && Chams.getInstance().chamsXD.getPropertyValue().equals(Chams.chamsMode.Colored) && entitylivingbaseIn.isEntityAlive() && !entitylivingbaseIn.isInvisible() && entitylivingbaseIn instanceof EntityPlayer && entitylivingbaseIn != Minecraft.getMinecraft().thePlayer){
                ...
                GlStateManager.color(Objects.requireNonNull(Chams.getInstance().color.getPropertyValue()).getRed() / 255f, Chams.getInstance().color.getPropertyValue().getGreen() / 255f, Chams.getInstance().color.getPropertyValue().getBlue() / 255f);
                else
                    GlStateManager.color(Objects.requireNonNull(new Color(HUD.getInstance().bozoColor).getRed() / 255f), new Color(HUD.getInstance().bozoColor).getGreen() / 255f, new Color(HUD.getInstance().bozoColor).getBlue() / 255f);
                GL11.glEnable(3042);
